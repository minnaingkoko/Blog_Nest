                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        @if(auth()->user()->isAuthor())
                            <x-nav-link :href="route('author.posts.index')" :active="request()->routeIs('author.*')">
                                {{ __('Author Panel') }}
                            </x-nav-link>
                        @endif
                    @endauth
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                @if(auth()->user()->isAuthor())
                    <x-responsive-nav-link :href="route('author.posts.index')" :active="request()->routeIs('author.*')">
                        {{ __('Author Panel') }}
                    </x-responsive-nav-link>
                @endif
            @else
