<x-guest-layout>
    ...
    <div class="mb-6 p-4 bg-blue-50 rounded-lg">
        <div class="flex items-start">
            <svg class="h-5 w-5 text-blue-500 mt-0.5 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                fill="currentColor">
    ...
    <div class="mt-8 pt-6 border-t border-gray-100 text-center text-sm text-gray-500">
        <p>Didn't receive the email? Check your spam folder or <a href="#"
                class="text-blue-600 hover:text-blue-500">contact support</a>.</p>
    </div>
