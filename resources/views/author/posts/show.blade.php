...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex space-x-4">
            <a href="{{ route('author.posts.edit', $post) }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition duration-200">
                Edit
            </a>
            <form action="{{ route('author.posts.destroy', $post) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this post?')">
                @csrf
                @method('DELETE')
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        ...
        <div class="p-6">
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
                <a href="{{ route('author.posts.index') }}" class="text-blue-600 hover:text-blue-800">
                    ← Back to all posts
                </a>
            </div>
        </div>
